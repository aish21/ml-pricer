...
DEFAULT_OUTPUT_ROOT = Path("data") / "surrogates" / "phoenix-v3"
...
def _dataset_config(
    ...
    *,
    ...
    return PhoenixDatasetConfig(
        ...
        markets_per_contract=args.markets_per_contract,
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Generate and train the Phoenix payoff-aware v3 research model."
    )
    ...
    def add_dataset_arguments(command_parser: argparse.ArgumentParser) -> None:
        ...
        command_parser.add_argument("--markets-per-contract", type=int, default=4)
